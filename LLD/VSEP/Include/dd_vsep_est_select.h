...
extern uint16_t VSEP_EST_Select_Txd[NUMBER_OF_VSEP][VSEP_EST_SELECT_TXD_MESSAGE_MAX];
extern uint16_t VSEP_EST_Select_Rxd[NUMBER_OF_VSEP][VSEP_EST_SELECT_RXD_MESSAGE_MAX];
#ifdef  VSEP_CALIBRATION_ENABLE
 extern uint16_t VSEP_EST_SELECT_INITIAL[NUMBER_OF_VSEP][VSEP_EST_SELECT_TXD_MESSAGE_MAX];
#else
extern const uint16_t VSEP_EST_SELECT_INITIAL[NUMBER_OF_VSEP][VSEP_EST_SELECT_TXD_MESSAGE_MAX];
#endif

...
//extern const uint16_t VSEP_FAULT_CHANNEL_MAP[VSEP_CHANNEL_MAX];
...
// @end
//=============================================================================
FAR_COS bool VSEP_Diagnostic_Get_Channel_Fault(IO_Configuration_T in_configuration,FAULT_T fault_type);

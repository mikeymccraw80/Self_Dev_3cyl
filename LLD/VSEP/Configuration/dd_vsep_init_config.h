...
extern const uint16_t VSEP_PCH_TXD_INITIAL[VSEP_PCH_TXD_MESSAGE_MAX];
extern const uint16_t VSEP_EST_FAULT_GRAD_INITIAL[VSEP_EST_FAULT_RXD_MESSAGE_MAX];
extern const uint8_t  VSEP_EST_FAULT_SYNC_MESSAGE_BYTE_INITIAL[VSEP_EST_FAULT_SYNC_TXD_MESSAGE_MAX_BYTE];
extern const uint16_t VSEP_FAULT_TXD[VSEP_FAULT_RXD_MESSAGE_MAX];
extern const uint16_t VSEP_PWM_TXD_INITIAL[VSEP_PWM_CHANNEL_MAX][VSEP_PWM_TXD_MESSAGE_MAX];

extern const uint32_t VSEP_TIMER_VR_Base_Frequency;
extern const uint16_t VSEP_VR_TXD_INITIAL[VSEP_VR_TXD_MESSAGE_MAX];
extern const uint16_t VSEP_SOH_STATUS_TXD[VSEP_SOH_STATUS_TXD_MESSAGE_MAX];

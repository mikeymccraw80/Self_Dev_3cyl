...
// VSEP_PWM_Set_Period
//=============================================================================
void VSEP_PWM_Set_Period(IO_Configuration_T in_configuration, uint32_t in_period, VSEP_PWM_Period_InType_T in_type)
{
...
// VSEP_PWM_Get_Period
//=============================================================================
uint32_t VSEP_PWM_Get_Period(IO_Configuration_T in_configuration, VSEP_PWM_Period_ReturnType_T return_type)
{
    uint16_t *pwm_buf = VSEP_PWM_Get_PWM_Buffer( in_configuration );
...
//=============================================================================
void VSEP_PWM_Set_Duty_Cycle(IO_Configuration_T in_configuration, uint32_t in_on_time, VSEP_PWM_DutyCycle_InType_T in_type)
{
...
//=============================================================================
uint32_t VSEP_PWM_Get_Duty_Cycle(IO_Configuration_T in_configuration, VSEP_PWM_DutyCycle_ReturnType_T return_type)
{
    uint16_t *pwm_buf = VSEP_PWM_Get_PWM_Buffer( in_configuration );
...
//=============================================================================
uint32_t VSEP_PWM_Timer_Get_Base_Frequency_HZ(IO_Configuration_T in_configuration)
{
...
//=============================================================================
void VSEP_PWM_DISCRETE_Channel_Initialize(IO_Configuration_T in_configuration)
{
...
//=============================================================================
void VSEP_PWM_DISCRETE_Channel_Clear(IO_Configuration_T in_configuration)
{
...
//=============================================================================
bool VSEP_PWM_DISCRETE_Get_State(IO_Configuration_T in_configuration)
{
...
//=============================================================================
void VSEP_PWM_DISCRETE_Set_Immediate_State(IO_Configuration_T in_configuration, bool in_state)
{
...
//=============================================================================
void VSEP_PWM_DISCRETE_Toggle_State(IO_Configuration_T in_configuration)
{
    VSEP_PWM_DISCRETE_Set_State(in_configuration, 
...
//=============================================================================
void VSEP_PWM_DISCRETE_Toggle_Immediate_State(IO_Configuration_T in_configuration)
{

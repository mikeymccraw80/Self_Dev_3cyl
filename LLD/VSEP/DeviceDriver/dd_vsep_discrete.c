...
#else
   VSEP_MPIO_MODE_Txd[ VSEP_MPIO_MODE_TXD_MESSAGE_CTRL ] = VSEP_Msg_Set_SDOA ( VSEP_MPIO_MODE_Txd[ VSEP_MPIO_MODE_TXD_MESSAGE_CTRL ], VSEP_RXD_SDOA_NOT_USED ); 
   VSEP_MPIO_MODE_Txd[ VSEP_MPIO_MODE_TXD_MESSAGE_CTRL ] = VSEP_Msg_Set_SDIA ( VSEP_MPIO_MODE_Txd[ VSEP_MPIO_MODE_TXD_MESSAGE_CTRL ], VSEP_TXD_SDIA_SETUP ); 
   VSEP_MPIO_MODE_Txd[ VSEP_MPIO_MODE_TXD_MESSAGE_MODE ] = VSEP_INIT_TXD_INITIAL[11];
#endif
}

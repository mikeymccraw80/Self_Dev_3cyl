...
extern uint16_t VSEP_SOH_Txd[VSEP_SOH_TXD_MESSAGE_MAX];
extern uint16_t VSEP_SOH_Rxd[VSEP_SOH_RXD_MESSAGE_MAX];
...
// @end
//=============================================================================
void VSEP_Calculate_Response( void * in_hclient );

...
void SIU_GPIO_Initialize_Device( void )
{
	...
	SIU.GPDO[SIU_GPIO_CHANNEL_123].F.PDO = false; //set ETC/L9958 Output
	...
	//SIU AD confige
	// GPIO 215
	SIU.PCR[SIU_GPIO_CHANNEL_215] =SIU_INITIAL_PCR_215 ;
	// GPIO 216
	SIU.PCR[SIU_GPIO_CHANNEL_216] =SIU_INITIAL_PCR_216 ;
	// GPIO 217
	SIU.PCR[SIU_GPIO_CHANNEL_217] =SIU_INITIAL_PCR_217 ;
	// GPIO 218
	SIU.PCR[SIU_GPIO_CHANNEL_218] =SIU_INITIAL_PCR_218 ;
	...
	if(CPU_Info == CPU_LCI) {
		// sepcial case for LCI
		SIU.GPDO[SIU_GPIO_CHANNEL_RESERVED_80] = SIU_INITIAL_PDO_80_LCI;
		SIU.GPDO[SIU_GPIO_CHANNEL_RESERVED_81] = SIU_INITIAL_PDO_81_LCI;
		SIU.GPDO[SIU_GPIO_CHANNEL_RESERVED_82] = SIU_INITIAL_PDO_82_LCI;
		SIU.GPDO[SIU_GPIO_CHANNEL_RESERVED_113] = SIU_INITIAL_PDO_113_LCI;
		SIU.PCR[SIU_GPIO_CHANNEL_RESERVED_113] = SIU_INITIAL_PCR_113_LCI;

...
void INTC_Initialize_Device(void)
{
   ...
   INTC.PSR[INTC_CHANNEL_PIT_2_CH].F.PRI = INTC_CHANNEL_PIT_2_PRIORITY;
   ...
   INTC.PSR[INTC_CHANNEL_FLEXCAN_A_BUFFER_31_16_CH].F.PRI = INTC_CHANNEL_FLEXCAN_A_BUFFER_31_16_PRIORITY;

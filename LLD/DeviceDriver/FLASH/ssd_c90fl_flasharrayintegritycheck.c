 ...
 *                                                                       *
 * FILE NAME     :  FlashArrayIntegrityCheck.c                           *
 ...
 *                 misrValue_Bk1 - contains the MISR values calculated   *
 *                  by the user for Bank 1.                              *
...
UINT32 ssd_c90fl_FlashArrayIntegrityCheck ( PSSD_CONFIG pSSDConfig,
                                  ...
                                  void (*CallBack)(void))
{
    ...
    if (0 != (lowEnabledBlocks | highEnabledBlocks))
    {
       ...
       returnCode = CFlashArrayIntegrityCheck(c90flRegBase,cLowEnabledBlocks,highEnabledBlocks,addrSeq);
       bkFlag |=0x01;
   }

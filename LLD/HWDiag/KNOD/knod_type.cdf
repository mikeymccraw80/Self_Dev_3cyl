...
#*
#* Description:       This is a common file used by knod subsystems. It
...
#* Current Module Info:
#* %derived_by:     vzp48z %
#* %full_name:      mt20u2#5/ascii/knod_type.cdf/1 %
#* %date_created:   Wed Mar 19 10:11:42 2008 %
#* %version:        1 %
#*
#*****************************************************************************/
...
#           (Index 0 : 500 to 6500 incr=500)
          ...
          .knod_rpm_09_brkpts_0to_6400
          {
            :kind = define_annotation;
            :units = "RPM";
#           (Index 0 : 0 to 6400 incr=800)
            :table = (0, 800, 1600, 2400, 3200, 4000, 4800, 5600, 6400) ;
          }

          .knod_percent_09_brkpts_0to_100
          {
            :kind = define_annotation;
            :units = "Percent";
...
#           (Index 0 : 0 to 7000 incr=1000)
          ...
          .knod_percent_05_brkpts_0to_100
          {
            :kind = define_annotation;
            :units = "Percent";
...
#           (Index 0 : 600 to 3000 incr=200, 3000 to 7000 incr=500)
          ...
          .knod_percent_17_brkpts_0to_100
          {
            :kind = define_annotation;
            :units = "Percent";
...
#                    (Index 0 : 0 to 6400 incr=400)
          ...
          .knod_pressure_11_brkpts_0to_100
          {
            :kind = define_annotation;
            :units = "KPA";
...
#
# 04/03/05     Shoujun     188
# + Add the module of Knock System diagnostics.
#   - Fixed annotation of knod_rpm_09_brkpts_0to_6400.
#
# 23/04/07     GuanHong	   mt20u2#130
# + To Detect Knock Sensor Failure When ESC Gain Larger Than Certain Value
#   - Add the type t_decibels for KfKNKD_FaultDetectGain
###############################################################################

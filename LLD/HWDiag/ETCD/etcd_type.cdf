...
#*
#* Description:       This is a common file used by etcd subsystems. It
...
#* Current Module Info:
#* %derived_by:     vzp48z %
#* %full_name:      mt20u2#5/ascii/etcd_type.cdf/1 %
...
#           (Index 0 : 500 to 6500 incr=500)
          ...
          .etcd_percent_09_brkpts_0to_100
          {
            :kind = define_annotation;
            :units = "Percent";
...
#           (Index 0 : 0 to 7000 incr=1000)
          ...
          .etcd_percent_05_brkpts_0to_100
          {
            :kind = define_annotation;
            :units = "Percent";
...
#           (Index 0 : 600 to 3000 incr=200, 3000 to 7000 incr=500)
          ...
          .etcd_percent_17_brkpts_0to_100
          {
            :kind = define_annotation;
            :units = "Percent";
...
#                    (Index 0 : 0 to 6400 incr=400)
          ...
          .etcd_pressure_11_brkpts_0to_100
          {
            :kind = define_annotation;
            :units = "KPA";

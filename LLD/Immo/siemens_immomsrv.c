...
FAR_COS void SiemensImmo_BldChallengeRspMsgFrame (void)
{
  ...
  {
    /* data->Tx.Data[0] is set as data->Rx.Data[0] + PositiveResponseOffset
       in SendStandardPositiveAnswer */ 
...
static void SiemensImmo_CntrlRLineSignal (void)
{
  ...
  */
  ...
  if ( (SbSiemens_RLineTriggerEnbl)
    && (SySiemens_RLineTimerCntr < CySiemens_RLineTimerCnt7p8ms ))
  {
     /* 16*7p8125ms = 125ms */
...
{
  if ( (VbSiemens_ECUPreEnable)
    && (SwSiemens_PreEnblTimerCntr < KwIMMO_SiemensPreReleaseTime ) )
  {
...
static void SiemensImmo_CntrlIMMOKWTime(void)
{
  if ( (SbSiemens_IMMOKWEnable)
    && (SwSiemens_IMMOKWEnblTimerCntr < CwSiemens_IMMOKWEnblTimerCnt7p8ms) )
  {

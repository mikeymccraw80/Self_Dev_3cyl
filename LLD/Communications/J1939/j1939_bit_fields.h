 ...
 * File Name:  j1939_bit_fields.h                                            *
 * File Description:                                                         *
 * This file contains bit field library function definition                  *
 *****************************************************************************/


#ifndef J1939_BIT_FIELDS_H
#define J1939_BIT_FIELDS_H
 ...
 *  #define CLK_DIV16          3
 *
 *  const Byte_Bit_Fld_T Clk_Div_Reg = { (uint8_t *)0xffaa,7,6}
 *
...
typedef struct {
    uint8_t *addr;      /* address of byte containing the bit fld    */
    uint8_t first_bit;  /* bit closest to bit 7                      */
    uint8_t last_bit;   /* bit closest to bit 0                      */
}Byte_Bit_Fld_T;

typedef struct {
    uint16_t *addr;     /* address of word containing the bit field  */
    uint8_t first_bit;  /* bit closest to bit 15                     */
    uint8_t last_bit;   /* bit closes  to bit 0                      */
}Word_Bit_Fld_T;

typedef struct {
    uint32_t *addr;     /* address of long word containing bit field */
    uint8_t first_bit;  /* bit closest to bit 31                     */
    uint8_t last_bit;   /* bit closest to bit 0                      */
}Long_Word_Bit_Fld_T;
...
extern uint8_t   Read_Byte_Bit_Fld(const Byte_Bit_Fld_T *bit_fld);
extern uint16_t  Read_Unsigned_Word_Bit_Fld(const Word_Bit_Fld_T *bit_fld);
extern uint16_t  Read_Unsigned_Word_From_Odd_Add_Bit_Fld(const Word_Bit_Fld_T *bit_fld);
extern sint16_t  Read_Signed_Word_Bit_Fld(const Word_Bit_Fld_T *bit_fld);
extern uint32_t  Read_Unsigned_Long_Word_Bit_Fld(const Long_Word_Bit_Fld_T *bit_fld);

extern uint32_t  Read_Unsigned_Long_Word_From_Odd_Add_Bit_Fld(const Long_Word_Bit_Fld_T *bit_fld);
 ...
 *                result to fit in a boolean_T or uint8_t,  *

...
******************************************************************************/
static bool Service_PGN_65299(J1939_Transmit_Message_Info_T *tx_msg_ptr)
{
    J1939_DATA_T *jd = (J1939_DATA_T *)&J1939_pgn_65299;

    tx_msg_ptr->ID                 = J1939_ADD_THIS_SRC_ADDR(J1939_PGN_65299_BASE_ID);
    tx_msg_ptr->Length             = J1939_PGN_65299_LENGTH;
    ...
    tx_msg_ptr->Callback_Time_W    = J1939_PGN_65299_FREQ;
    tx_msg_ptr->Callback_Timeout_W = J1939_PGN_65299_TIMEOUT;
    return(true);
}
/******************************************************************************
...
******************************************************************************/
void J1939_TxInit_PGN_65299(J1939_Transmit_Message_Control_T * MsgCtrl) 
{
    MsgCtrl->Service_Routine        = Service_PGN_65299;
    MsgCtrl->Time_To_Service        = 0x00;
    MsgCtrl->Time_To_Next_Service_W = J1939_PGN_65299_FREQ;
    MsgCtrl->Tx_Timeout             = 0x00;
    MsgCtrl->Tx_Timeout_Timer_W     = J1939_PGN_65299_TIMEOUT;
}

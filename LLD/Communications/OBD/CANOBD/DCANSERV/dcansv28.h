...
#define AppCommunicationType  0x01
...
#else /* SID_28 not Supported */
#define LnCommunicationControl        ServiceNotSupported_DCAN

#endif /* (XeDCAN_SID_28_Supported == CeDCAN_Supported) */

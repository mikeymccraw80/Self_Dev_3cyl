...
void KwJ14230ReadDataByLocalIdentifier( void )
{
   ...
   else
   {
      ...
      switch ( GetKw2000ServiceData(IdxLocalIdentifier) )
      {
         ...
         WrtKw2000ServiceData( Vsp_b, TrByteCount++);
        ...
        WrtKw2000ServiceData( Hi8Of16(Tpp), TrByteCount++);
         WrtKw2000ServiceData( Lo8Of16(Tpp), TrByteCount++);
	...
	WrtKw2000ServiceData( TpPos_b, TrByteCount++);
       ...
       WrtKw2000ServiceData( Lo8Of16(uPmap), TrByteCount++);
        ...
        WrtKw2000ServiceData( Hi8Of16(uTps), TrByteCount++);
       WrtKw2000ServiceData( Lo8Of16(uTps), TrByteCount++);

        WrtKw2000ServiceData( Hi8Of16(Ti), TrByteCount++);
       WrtKw2000ServiceData( Lo8Of16(Ti), TrByteCount++);


        WrtKw2000ServiceData( NDsrIdc, TrByteCount++);

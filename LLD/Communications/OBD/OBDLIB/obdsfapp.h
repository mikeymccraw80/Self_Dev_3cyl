 ...
 * Filename:          obdsfapp.h
 * 
 * Description:       This header file defines all necessary input resources of IMMO/Vehicle CAN
 ...
 * 
 * Current Module Info:
 * %full_name:      mt20u2#1/incl/obdsfapp.h/1 %
 * %date_created:   Fri Sep 10 14:33:13 2010 %
 * %version:        1 %
 * %derived_by:     pz0vmh %
 * 
 *****************************************************************************/

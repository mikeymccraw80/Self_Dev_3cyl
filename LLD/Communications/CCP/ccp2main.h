...
\*===========================================================================*/
CCP_CRC_T CCP_Process_Command( HUGE uint8_t* );
 ...
 * Return Value: None
\*===========================================================================*/
void CCP_Send_Delayed_CRM( CCP_CRC_T );
...
\*===========================================================================*/
bool CCP_Send_User( uint8_t*, uint32_t );
 ...
 * Return Value: CCP_CRC_T, command response code
\*===========================================================================*/
CCP_CRC_T CCP_Write_To_REGISTER_Memory_User( HUGE uint8_t*, uint8_t );
...
\*===========================================================================*/
uint8_t CCP_Read_From_REGISTER_Memory_User( HUGE uint8_t* );

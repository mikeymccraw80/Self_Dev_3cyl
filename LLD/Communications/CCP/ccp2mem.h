...
#error
   ...
   /* Convert 32-bit value stored bytewise in big endian to little endian */
   #define FIX_BIG_ENDIAN32( a ) ( (((a) & 0x000000FFUL) << 24) | \
                                   (((a) & 0x0000FF00UL) <<  8) | \
                                   (((a) & 0x00FF0000UL) >>  8) | \
                                   (((a) & 0xFF000000UL) >> 24) )
   /* Convert 16-bit value stored bytewise in big endian to little endian */
   #define FIX_BIG_ENDIAN16( a ) ( ((uint16_t)((a) & 0x00FF) << 8) | \
                                   ((uint16_t)((a) & 0xFF00) >> 8) )
   /* No conversion necessary */
   #define FIX_LITTLE_ENDIAN16( a ) ( a )
#else
   /* No conversion necessary */

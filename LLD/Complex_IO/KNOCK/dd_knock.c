...
void KNOCK_Initialize(void)
{
   ...
   KNOCK_Tooth_Count_TDC_to_CylEvt = KNOCK_Teeth_Per_Cylinder_Event - KNOCK_Tooth_Count_From_Cylinder_Event_To_TDC;  //7 for B38
...
void KNOCK_Cylinder_Event_MultiKnock(void)
{
 ...
 //  HAL_GPIO_SET_VGIS2_Enable(true);
   //calculate all wingate edges
   //do not use wingate 1 in Mt62 application
   //  KNOCK_REF_To_WindowBegin1 = KNOCK_Angle_From_Cylinder_Event_To_TDC+
   //            KNOCK_Window_Begin1; //*(CRANK_DEGREES_PER_TOOTH<< (S_CRANK_ANGLEa)))>>uCRANK_ANGLE_PRECISION  ;
   // KNOCK_REF_To_WindowEnd1 =  KNOCK_Angle_From_Cylinder_Event_To_TDC  + 
   //	       KNOCK_Window_End1; //*(CRANK_DEGREES_PER_TOOTH<< (S_CRANK_ANGLEa)))>>uCRANK_ANGLE_PRECISION  ;

   if(KNOCK_Window_Begin2>=0)
   {
      KNOCK_REF_To_WindowBegin2 =  KNOCK_Angle_From_Cylinder_Event_To_TDC 
         + KNOCK_Window_Begin2; //*(CRANK_DEGREES_PER_TOOTH<< (S_CRANK_ANGLEa)))>>uCRANK_ANGLE_PRECISION ;
   }
   else
   {
      KNOCK_REF_To_WindowBegin2 =  KNOCK_Angle_From_Cylinder_Event_To_TDC  
...
//   }
 ...
 KNOCK_REF_To_WindowEnd2 = KNOCK_REF_To_WindowBegin2 + KNOCK_Window_End2;
   ...
   KNOCK_Ref_to_WindowBegin2_time 
...
//  HAL_GPIO_SET_VGIS2_Enable(false);
}
//=============================================================================
// KNOCK_Initialize
//=============================================================================
...
void SWI_Knock_INT( void )
{
   ...
   uint32_t   test_count;
   //HAL_GPIO_SET_VGIS2_Enable(true);
   // IO_DISCRETE_Set_State( &MTSA_D_OUT_PDA, true );
   // io->I->Interrupt.Clear_Pending(io->Configuration);
  // INTC_INTERRUPT_Set_SW1_Interrupt(false);
...
{
   //return KNOCK_Flags.window2_is_closed;

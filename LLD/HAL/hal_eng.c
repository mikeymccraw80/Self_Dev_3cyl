...
//=============================================================================
// HAL_Eng_Get_CAM1_Engine_Speed
//=============================================================================
uint16_t HAL_Eng_Get_CAM1_Engine_Speed(void)
{
	return  (uint16_t)CAM_Get_CAM1_EngineSpeed();
}

//=============================================================================
// HAL_Eng_Get_CAM1_Reference_Time
//=============================================================================
uint32_t HAL_Eng_Get_CAM1_Reference_Time(void) 
{
	return  (uint32_t)CAM_Get_CAM1_Period();
}

//=============================================================================
// HAL_Eng_Get_CAM_Backup_Flag
//=============================================================================
bool HAL_Eng_Get_CAM_Backup_Flag(void)
{
	return CRANK_Get_Flag(CRANK_FLAG_CAM_BACKUP);
}

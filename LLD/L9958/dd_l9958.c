...
{
	L9958_Txd.Value = L9958_TXD_INITIAL;
...
{
	L9958_Txd.Value = L9958_Msg_Set_Diag_Reset_Disable(L9958_Txd.Value, in_diag_rst_disable);
}
...
{
	L9958_Txd.Value = L9958_Msg_Set_Regulation_Curr_Level(L9958_Txd.Value, in_curr_level);
}
...
{
	L9958_Txd.Value = L9958_Msg_Set_Voltage_Slew_Control(L9958_Txd.Value, in_volt_slew);
}
...
{
	L9958_Txd.Value = L9958_Msg_Set_Current_Slew_Control(L9958_Txd.Value, in_curr_slew);
}
...
{
	L9958_Txd.Value = L9958_Msg_Set_Current_Slew_Control_Disable(L9958_Txd.Value, in_curr_slew_Disable);
}
...
{
	L9958_Txd.Value = L9958_Msg_Set_Open_Load_in_ON_Enable(L9958_Txd.Value, in_open_load_state);
}

...
#define __MG_EEEP_PML_WRITE_TEST
...
#define __MG_GENERAL_PORT_WRITE_TEST
#define __MG_EST_TEST
#define __MG_ETC_TEST
#define __MG_FUEL_PUMP_OUTPUT_TEST
...
#define __MG_BARO_SENSOR_TEST_H
#define __MG_LIN_TEST
...
#define __MG_KP254_FAULT_DIAGNOSTIC_TEST

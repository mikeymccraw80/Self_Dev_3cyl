...
void mg_HAL_PWM_Set_Discrete_Out_Group_Frequency_And_Duty(uint8_t index)
{
    ...
    {
        IO_PULSE_PWM_Set_Frequency_And_Duty_Cycle(MG_HAL_DISCRETE_OUT_GROUP[index].io, MG_HAL_DISCRETE_OUT_GROUP[index].frequency, 0, MG_HAL_DISCRETE_OUT_GROUP[index].duty, 100);
    }
}
...
void mg_HAL_PWM_Set_Discrete_Out_Group_Frequency_And_Duty_Immediate(uint8_t index)
{
    if (NULL != MG_HAL_DISCRETE_OUT_GROUP[index].io)
    {
        IO_PULSE_PWM_Set_Frequency_And_Duty_Cycle_Immediate(MG_HAL_DISCRETE_OUT_GROUP[index].io, MG_HAL_DISCRETE_OUT_GROUP[index].frequency, 0, MG_HAL_DISCRETE_OUT_GROUP[index].duty, 100);
    }
}

...
MG_HAL_DISCRETE_OUT_T MG_HAL_DISCRETE_OUT_GROUP[] = 
{
    ...
    { MG_HIODEVICE_DO_DFB15, NOT_CARE, NOT_CARE, NOT_CARE, NOT_CARE, DISCRETE },
    ...
    { MG_HIODEVICE_DO_DFB21, NOT_CARE, NOT_CARE, NOT_CARE, NOT_CARE, DISCRETE },
    { MG_HIODEVICE_DO_DFB22, NOT_CARE, NOT_CARE, NOT_CARE, NOT_CARE, DISCRETE },
    ...
    { MG_HIODEVICE_DO_DFB27, NOT_CARE, NOT_CARE, NOT_CARE, NOT_CARE, DISCRETE },

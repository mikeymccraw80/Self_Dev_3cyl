...
typedef uint16_t               Filter_Q_W ;                /* --- Range 0.0 .. <1.0 --- */
#define Prec_Filter_Q_W                 ( 1.0 / 65536 )
#define Min_Filter_Q_W                          ( 0.0 )
#define Max_Filter_Q_W          ( 65535 * 1.0 / 65536 ) 
/*---------------------------------*/
/*---                           ---*/
...
typedef uint32_t               Volt0to5Volts_L ;
/* resolution of Vols0to5volts_W but longer to handle overflow */
#define Prec_Volt0to5Volts_L                 ( 5.0 / 65536 )
#define Min_Volt0to5Volts_L                          ( 0.0 )
#define Max_Volt0to5Volts_L   ( MAX_UL * 5.0 / 65536 )
...
typedef uint16_t               Volt0to31p99Volts_W ;
#define Prec_Volt0to31p99Volts_W                 ( 31.99 / 65536 )
#define Min_Volt0to31p99Volts_W                            ( 0.0 )
#define Max_Volt0to31p99Volts_W   ( 65535 * Prec_Volt0to5Volts_W )
#define RFactor_Volt0to5Volts_W_Volt0to31p99Volts_W ( 65536.0 )


typedef uint16_t               Percent0To200_Plus_Fraction ;
#define Prec_Percent0To200_Plus_Fraction         ( 200.0 / 65536 )
#define Min_Percent0To200_Plus_Fraction                    ( 0.0 )
#define Max_Percent0To200_Plus_Fraction  ( 65535 * 200.0 / 65536 )
#define RFactor_Percent_Plus_Fraction_Percent0To200_Plus_Fraction  ( 256.0 )
...
typedef uint8_t              TPS_B ;
#define Prec_TPS_B                    ( 100.0 / 256 )
#define Min_TPS_B                             ( 0.0 )
#define Max_TPS_B                ( 255 * Prec_TPS_B )

/**************** Type Definitions ******************/

typedef kPa_W                               kPa_W_NonLinear ;
#define Prec_kPa_W_NonLinear ( Prec_kPa_W )
#define Min_kPa_W_NonLinear  ( Min_kPa_W )
#define Max_kPa_W_NonLinear  ( 130.0 )  /* 130.0 is equivalent to 105.0 on the
                                           linear scale. */
/*----------------------------------*/
/*---                            ---*/
/*---      General macros        ---*/
